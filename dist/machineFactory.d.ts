import { StateType, MachineEvent, StateDefinition } from './StateMachine';
 ...
 */
export declare function machineFactory<C extends any>(config: RootStateDefinition<C>): Machine<C>;
